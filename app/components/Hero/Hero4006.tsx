...
export default function Hero4006() {
    return (
        <section
            ...
            className="relative z-0 text-left text-[62.5%] pt-[90px] h-[100vh] lg:pt-0 lg:h-[770px] overflow-hidden"
        >
            {/* 背景画像（右側・全体の背景） */}
            <div
            ...
            {/* モバイル用背景画像（下部） */}
            <div
                className="absolute bottom-0 left-0 right-0 h-[50%] z-0 lg:hidden bg-cover bg-no-repeat"
                style={{ backgroundImage: "url('/img/Hero4006_Background_3.png')", backgroundPosition: "center 30%" }}
            />

            {/* モバイル用灰色背景（上部・斜めカット） */}
            <div
                className="absolute top-0 left-0 right-0 h-[60%] bg-[#E2E2E2] z-10 lg:hidden"
            ...
            <div className="relative mx-auto px-[5%] lg:px-0 w-full lg:w-[1100px] lg:pt-[125px] z-20">
                ...
                <div className="content w-full lg:w-[580px]">
                    <div className="catch_area">
                        {/* タイトル */}
                        <h1 className={`main_txt pt-10 lg:pt-0 text-center mb-[25px] lg:mb-[40px] text-[7em]
                             lg:text-[8rem] tracking-[0.02em] leading-none text-[#333] ${doppioOne.className}`}>
                            MAXHUB
                        </h1>
                ...
                px-[5px] pt-[5px] pb-[2px] lg:pt-0 font-bold"
                        >
                            <span
              ...
              text-[2.0em] lg:text-[3.6em] leading-[1.6] pb-[10px] lg:pb-[20px]">
                  ...
                  w-full lg:w-auto
                  bg-[url('/img/Hero4006_Icon_1.png'),linear-gradient(90deg,#716A3E_0%,#3C3609_100%)]
                  bg-no-repeat bg-[position:50px_center,0_0] lg:bg-[position:50px_center,0_0]
