...
const LOGO_FILES = ["001.png", "002.png", "003.png", "004.png", "005.png", "006.png", "007.png"];

export default function Hero4007() {
    return (
        <section id="liteview-register" className="main pt-[67px] px-4 max-[1199px]:pb-0">
            <div className="main__inner bg-[#f1f6f6] rounded-[40px] relative max-[1199px]:p-10 max-[1199px]:px-[25px] min-[1200px]:p-[140px] min-[1200px]:px-[65px]">
                ...
                <div className="main__text max-w-[50%] max-[1199px]:max-w-full">
                    <div className="main__text-cap text-[#717171] max-[1199px]:text-[14px] min-[1200px]:text-[16px] pb-4">
                        社員の定着率アップと<br className="sp" />業務効率化の実現
                    </div>
                    <div className="main__text-main font-bold leading-[64px] min-[1200px]:text-[48px] max-[1199px]:text-[6vw] max-[1199px]:leading-snug pb-0 min-[1200px]:pb-12">
                        低予算で<br />社内ポータルを即構築<br />
                        <ruby>
                            LITEVIEW Team <rt className="block text-[40%] -mb-4 min-[1200px]:-mb-4 max-[1199px]:-mb-2 pl-[4%] min-[1200px]:pl-[2%] tracking-[5px]">ライトビュー チーム</rt>
                        </ruby>
                    </div>
                    {/* ボタン */}
                    <div className="main__text-btn flex flex-col min-[1200px]:flex-row">
                        <div>
                            <a
                                id="btn_document_top_fv"
                                className="main__text-btn-contents inline-block font-bold text-white text-[16px] bg-[#23333b] border border-[#23333b] rounded-[104px] leading-none relative transition-all duration-300 px-9 pr-14 py-6 mb-8 min-[1200px]:mb-8 hover:bg-white hover:text-[#23333b]"
                                style={{}}
                            >
                                2025年12月上旬正式オープン予定
                        ...
                        <div>
                            <a
                                ...
                                className="inline-block font-bold text-[#23333b] text-[16px] relative ml-0 min-[1200px]:ml-9"
                            >
                                無料相談のご予約
                ...
                <div className="main__image absolute top-0 bottom-0 right-0 text-right w-1/2 h-full rounded-r-[40px] overflow-hidden max-[1199px]:static max-[1199px]:w-full max-[1199px]:h-auto max-[1199px]:text-center">
                    <div className="main__image-video w-full h-full overflow-hidden flex items-center justify-center">
                        <Image
                            src="/img/fv-image.png" // liveteam/live_files/fv-image.png を public/img へコピー
                            alt=""
                            width={680}
                            height={600}
                    ...
                    <div className="main__image-cert absolute w-40 right-6 bottom-6 max-[1199px]:static max-[1199px]:mt-6 max-[1199px]:w-40">
                        <Image
                            src="/img/cert_logo.png" // liveteam/live_files/cert_logo.png を public/img へコピー
                ...
                <div className="overflow-hidden w-full">
                    ...
                    <Marquee duration={60000}>
                        {Array(2)
                            ...
                            .flatMap(() => LOGO_FILES)
                            .map((file, i) => (
                                <div key={i} className="logo-image inline-block mx-[50px] max-[1199px]:mx-[20px]">
                                    <Image
...
function Marquee({ children, duration }: { children: React.ReactNode; duration: number }) {
